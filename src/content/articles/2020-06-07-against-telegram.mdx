...
Perhaps even more concerning is the fact that group chats in Telegram _cannot_ be end-to-end encrypted. Secret chats are reserved for one-on-one communication. Given that large group chats is often cited as one of the key appeals of Telegram, it's surprising that this crucial gotcha is rarely mentioned.
